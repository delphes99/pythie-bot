...
import fr.delphes.features.twitch.streamerHighlight.LegacyStreamerHighlightState
...
class IncomingRaid(
    ...
    stateManagerWithRepository: StateManagerWithRepository<LegacyStreamerHighlightState>,
    val incomingRaidResponse: (IncomingRaid) -> List<OutgoingEvent>,
    private val clock: Clock = SystemClock,
) : NonEditableFeature,
    TwitchFeature,
    WithStateManager<LegacyStreamerHighlightState> by stateManagerWithRepository {
