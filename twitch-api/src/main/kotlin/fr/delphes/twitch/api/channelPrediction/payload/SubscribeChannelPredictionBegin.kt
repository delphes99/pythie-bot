...
@Serializable
class SubscribeChannelPredictionBegin(
    override val condition: ChannelPredictionBeginCondition,
    override val transport: SubscribeTransport,
    override val version: String = "1"
): EventSubSubscribe<ChannelPredictionBeginCondition> {
    override val type: EventSubSubscriptionType = EventSubSubscriptionType.CHANNEL_PREDICTION_BEGIN
}